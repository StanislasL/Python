"""
Created on Thu Dec 29 15:31:26 2016
...
can1=tki.Canvas(fen,width=fw*9,height=(fw*4.5)+1,bg='cyan')
...
def affiche():
    ...
    if y0 < fw*4.5:
        ...
        for i in range(128):
            ...
            can1.create_rectangle(x0,y0,x0+9 ,y0+9 ,fill=farbe[now0[i]], outline= 'cyan')
...
def newgen():
    ...
    for p in range(1,fw-1):      
        ...
        # the rule 30 says that when nb is greater than 100 or equal to 0, the the cell dies
        if (nb > 100)or (nb==0):
            aft0[p]=0
